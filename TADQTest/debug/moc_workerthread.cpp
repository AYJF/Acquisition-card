...
QT_MOC_LITERAL(1, 13, 9), // "toRawData"
QT_MOC_LITERAL(2, 23, 0) // ""

    },
    "WorkerThread\0toRawData\0"
};
...
void WorkerThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->toRawData((*reinterpret_cast< double(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (WorkerThread::*_t)(double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&WorkerThread::toRawData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void WorkerThread::toRawData(double _t1)
{
