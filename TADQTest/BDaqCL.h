...
public: // Methods
  // __declspec( property( get = _get_Handle ) )
    //HANDLE Handle;
   HANDLE _get_Handle()
   {
  ...
  // __declspec( property( get = _get_Property ) )
  // BDaqProperty &Property;
   BDaqProperty & _get_Property( )
   {
      return m_property;
   }

   BDaqProperty &Property = _get_Property();
   //__declspec( property( get = _get_Event ) )
   BDaqEvent &Event = _get_Event();
...
public:
   ...
   //__declspec( property( get = _get_DeviceNumber ) )
   long DeviceNumber;
  ...
  // __declspec( property( get = _get_DeviceMode   ) )
   AccessMode Mode;
...
protected:// methods for internal using only
   ...
   virtual void Release()
   {
      if (InterlockedDecrement(&m_refCount) == 0)
      {
         ...
         AdxDeviceClose(this->_get_Handle());
...
{
   return AdxEventGetHandle(m_parent->_get_Handle(), id, &eventHandle);
}
inline long BDaqEvent::GetStatus(EventId id)
{
   long statusLParam = 0;
   AdxEventGetLastStatus(m_parent->_get_Handle(), id, &statusLParam, NULL);
   return statusLParam;
}
inline long BDaqEvent::GetStatus(EventId id, long & statusRParam)
{
   long statusLParam = 0;
   statusRParam = 0;
   AdxEventGetLastStatus(m_parent->_get_Handle(), id, &statusLParam, &statusRParam);
   return statusLParam;
}
inline void BDaqEvent::ClearFlag(EventId id, long flagLParam, long flagRParam)
{
   AdxEventClearFlag(m_parent->_get_Handle(), id, flagLParam, flagRParam);
}
...
{
   long dataLength;
   AdxPropertyRead(m_parent->_get_Handle(), id, 0, NULL, &dataLength, NULL);
   return dataLength;
}
inline PropertyAttribute BDaqProperty::GetAttribute(PropertyId id)
{
   long propAttr = 0;
   AdxPropertyRead(m_parent->_get_Handle(), id, 0, NULL, NULL, &propAttr);
...
{
   return AdxPropertyRead(m_parent->_get_Handle(), id, sizeof(int), &data, NULL, NULL);
}

inline ErrorCode BDaqProperty::Get(PropertyId id, long& data)
{
   return AdxPropertyRead(m_parent->_get_Handle(), id, sizeof(long), &data, NULL, NULL);
}
inline ErrorCode BDaqProperty::Get(PropertyId id, double& data)
{
   return AdxPropertyRead(m_parent->_get_Handle(), id, sizeof(double), &data, NULL, NULL);
}
inline ErrorCode BDaqProperty::Get(PropertyId id, MathInterval& data)
{
   return AdxPropertyRead(m_parent->_get_Handle(), id, sizeof(MathInterval), &data, NULL, NULL);
}

// get array type property
inline ErrorCode BDaqProperty::Get(PropertyId id, long count, BYTE data[])
{
   return AdxPropertyRead(m_parent->_get_Handle(), id, count * sizeof(BYTE), data, NULL, NULL);
}
inline ErrorCode BDaqProperty::Get(PropertyId id, long count, long data[])
{
   return AdxPropertyRead(m_parent->_get_Handle(), id, count * sizeof(long), data, NULL, NULL);
}
inline ErrorCode BDaqProperty::Get(PropertyId id, long count, double data[])
{
   return AdxPropertyRead(m_parent->_get_Handle(), id, count * sizeof(double), data, NULL, NULL);
}
inline ErrorCode BDaqProperty::Get(PropertyId id, long count, WCHAR data[])
{
   return AdxPropertyRead(m_parent->_get_Handle(), id, count * sizeof(WCHAR), data, NULL, NULL);
}
...
{  
   ...
   return AdxPropertyWrite(m_parent->_get_Handle(), id, sizeof(int), (void*)&data, NotifyPropertyChanged);
}

inline ErrorCode BDaqProperty::Set(PropertyId id, long data)
{
   return AdxPropertyWrite(m_parent->_get_Handle(), id, sizeof(long), (void*)&data, NotifyPropertyChanged);
}
inline ErrorCode BDaqProperty::Set(PropertyId id, double data)
{
   return AdxPropertyWrite(m_parent->_get_Handle(), id, sizeof(double), (void*)&data, NotifyPropertyChanged);
}
inline ErrorCode BDaqProperty::Set(PropertyId id, MathInterval data)
{
   return AdxPropertyWrite(m_parent->_get_Handle(), id, sizeof(MathInterval), (void*)&data, NotifyPropertyChanged);
}

// set array type property
inline ErrorCode BDaqProperty::Set(PropertyId id, long count, BYTE data[])
{
   return AdxPropertyWrite(m_parent->_get_Handle(), id, count * sizeof(BYTE), data, NotifyPropertyChanged);
}
inline ErrorCode BDaqProperty::Set(PropertyId id, long count, long data[])
{
   return AdxPropertyWrite(m_parent->_get_Handle(), id, count * sizeof(long), data, NotifyPropertyChanged);
}
inline ErrorCode BDaqProperty::Set(PropertyId id, long count, double data[])
{
   return AdxPropertyWrite(m_parent->_get_Handle(), id, count * sizeof(double), data, NotifyPropertyChanged);
}
inline ErrorCode BDaqProperty::Set(PropertyId id, long count, WCHAR data[])
{
   return AdxPropertyWrite(m_parent->_get_Handle(), id, count * sizeof(WCHAR), data, NotifyPropertyChanged);
}
...
{
   return AdxAiReadSamples(this->_get_Handle(), channel, 1, NULL, &dataScaled);
}
// for the device whose raw data is in 16bits format
inline ErrorCode BDaqAi::Read(long channel, short& dataRaw)
{
   return AdxAiReadSamples(this->_get_Handle(), channel, 1, &dataRaw, NULL);
}
...
{
   return AdxAiReadSamples(this->_get_Handle(), chStart, chCount, NULL, dataScaled);
}
// for the device whose raw data is in 16bits format
inline ErrorCode BDaqAi::Read(long chStart, long chCount, short dataRaw[], double dataScaled[]) 
{
   return AdxAiReadSamples(this->_get_Handle(), chStart, chCount, dataRaw, dataScaled);
}
// for the device whose raw data is in 32bits format
...
{
   return AdxBufferedAiPrepare(this->_get_Handle(), dataCount, dataRaw);
}
inline ErrorCode BDaqAi::BfdAiRunOnce(bool asynchronous)
{
   return AdxBufferedAiRunOnce(this->_get_Handle(), asynchronous ? 1 : 0);
}
inline ErrorCode BDaqAi::BfdAiRun()
{
   return AdxBufferedAiRun(this->_get_Handle());
}
inline ErrorCode BDaqAi::BfdAiScaleData(void* dataRaw, double dataScaled[], long dataCount, long* chOffset)
{
   return AdxBufferedAiScaleData(this->_get_Handle(), dataRaw, dataScaled, dataCount, chOffset);
}
inline ErrorCode BDaqAi::BfdAiStop()
{
   return AdxBufferedAiStop(this->_get_Handle());
}
inline ErrorCode BDaqAi::BfdAiRelease()
{
   return AdxBufferedAiRelease(this->_get_Handle());
}
...
{
   return AdxAoWriteSamples(this->_get_Handle(), channel, 1, NULL, (double*)&dataScaled);
}
// for the device whose raw data is in 16bits format
inline ErrorCode BDaqAo::Write(long channel, short dataRaw)
{
   return AdxAoWriteSamples(this->_get_Handle(), channel, 1, (void*)&dataRaw, NULL);
}
// for the device whose raw data is in 32bits format
...
{
   return AdxAoWriteSamples(this->_get_Handle(), chStart, chCount, NULL, dataScaled);
}
// for the device whose raw data is in 16bits format
inline ErrorCode BDaqAo::Write(long chStart, long chCount, short dataRaw[])
{
   return AdxAoWriteSamples(this->_get_Handle(), chStart, chCount, dataRaw, NULL);
}
// for the device whose raw data is in 32bits format
...
{
   return AdxBufferedAoPrepare(this->_get_Handle(), dataCount, dataRaw);
}
inline ErrorCode BDaqAo::BfdAoRunOnce(bool asynchronous)
{
   return AdxBufferedAoRunOnce(this->_get_Handle(), asynchronous ? 1 : 0);
}
inline ErrorCode BDaqAo::BfdAoRun()
{
   return AdxBufferedAoRun(this->_get_Handle());
}
inline ErrorCode BDaqAo::BfdAoScaleData(double dataScaled[], void* dataRaw, long dataCount, long* chOffset)
{
   return AdxBufferedAoScaleData(this->_get_Handle(), dataScaled, dataRaw, dataCount, chOffset);
}
inline ErrorCode BDaqAo::BfdAoStop(long action)
{
   return AdxBufferedAoStop(this->_get_Handle(), action);
}
inline ErrorCode BDaqAo::BfdAoRelease()
{
   return AdxBufferedAoRelease(this->_get_Handle());
}
...
{
   return AdxDiReadPorts(this->_get_Handle(), port, 1, &data);
}
inline ErrorCode BDaqDio::DiRead(long portStart, long portCount, BYTE data[])
{
   return AdxDiReadPorts(this->_get_Handle(), portStart, portCount, data);
}

inline ErrorCode BDaqDio::DoWrite(long port, BYTE data)
{
   return AdxDoWritePorts(this->_get_Handle(), port, 1, &data);
}
inline ErrorCode BDaqDio::DoWrite(long portStart, long portCount, BYTE data[])
{
   return AdxDoWritePorts(this->_get_Handle(), portStart, portCount, data);
}

inline ErrorCode BDaqDio::DoRead(long port, BYTE& data)
{
   return AdxDoReadBackPorts(this->_get_Handle(), port, 1, &data);
}
inline ErrorCode BDaqDio::DoRead(long portStart, long portCount, BYTE data[])
{
   return AdxDoReadBackPorts(this->_get_Handle(), portStart, portCount, data);
}

// DI snap methods
inline ErrorCode BDaqDio::DiSnapStart(EventId id, long portStart, long portCount, BYTE** buffer)
{
   return AdxDiSnapStart(this->_get_Handle(), id, portStart, portCount, buffer);
}
inline ErrorCode BDaqDio::DiSnapStop(EventId id)
{
   return AdxDiSnapStop(this->_get_Handle(), id);
}

// Buffered DI methods
inline ErrorCode BDaqDio::BfdDiPrepare(long dataCount, void* * data)
{
   return AdxBufferedDiPrepare(this->_get_Handle(), dataCount, data);
}
inline ErrorCode BDaqDio::BfdDiRunOnce(bool asynchronous)
{
   return AdxBufferedDiRunOnce(this->_get_Handle(), asynchronous ? 1 : 0);
}
inline ErrorCode BDaqDio::BfdDiRun()
{
   return AdxBufferedDiRun(this->_get_Handle());
}
inline ErrorCode BDaqDio::BfdDiStop()
{
   return AdxBufferedDiStop(this->_get_Handle());
}
inline ErrorCode BDaqDio::BfdDiRelease()
{
   return AdxBufferedDiRelease(this->_get_Handle());
}

// Buffered DO methods
inline ErrorCode BDaqDio::BfdDoPrepare(long dataCount, void* * data)
{
   return AdxBufferedDoPrepare(this->_get_Handle(), dataCount, data);
}
inline ErrorCode BDaqDio::BfdDoRunOnce(bool asynchronous)
{
   return AdxBufferedDoRunOnce(this->_get_Handle(), asynchronous ? 1 : 0);
}
inline ErrorCode BDaqDio::BfdDoRun()
{
   return AdxBufferedDoRun(this->_get_Handle());
}
inline ErrorCode BDaqDio::BfdDoStop(long action)
{
   return AdxBufferedDoStop(this->_get_Handle(), action);
}
inline ErrorCode BDaqDio::BfdDoRelease()
{
   return AdxBufferedDoRelease(this->_get_Handle());
}
...
inline ErrorCode BDaqDevice::GetModule(ModuleType type, long index, BDaqModule* & module)
{
   ...
   {
      HANDLE moduleHandle;
      ret = AdxDeviceGetModuleHandle(this->_get_Handle(), type, index, &moduleHandle);
      if (ret == Success)
      {
         switch (type)
         {
...
{
   return AdxDeviceRefreshProperties(this->_get_Handle());
}

inline ErrorCode BDaqDevice::ShowModalDialog(HWND parentWnd, long dataSource)
{
   HWND dlgWnd;
   return AdxDeviceShowConfigDialogBox(this->_get_Handle(), parentWnd, NULL, dataSource, 1, &dlgWnd);
}
inline ErrorCode BDaqDevice::ShowPopupDialog(HWND parentWnd, long dataSource, HWND* dlgWnd)
{
   return AdxDeviceShowConfigDialogBox(this->_get_Handle(), parentWnd, NULL, dataSource, 0, dlgWnd);
}
inline ErrorCode BDaqDevice::ShowEmbedDialog(HWND parentWnd, RECT* wndRect, long dataSource, HWND* dlgWnd)
{
   return AdxDeviceShowConfigDialogBox(this->_get_Handle(), parentWnd, wndRect, dataSource, 0, dlgWnd);
}
inline ErrorCode BDaqDevice::Reset(long state)
{
   return AdxDeviceReset(this->_get_Handle(), state);
}
